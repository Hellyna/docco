...
(function() {
  var Docco, _, buildMatchers, commander, configure, defaults, document, format, fs, getLanguage, highlightjs, languages, marked, mkdirp, parse, path, run, version, write,
    slice = [].slice;
  ...
  write = function(source, sections, config) {
    var cssurl, filepath, first, firstSection, getpaths, hasTitle, html, paths, title, url;
    getpaths = function(file) {
      var _basename, _dirname, _extname, baseurl, relpath, urlprefix;
      _extname = path.extname(file);
      _dirname = path.dirname(file);
      _basename = path.basename(file, _extname);
      urlprefix = config.urlprefix;
      baseurl = urlprefix != null ? urlprefix : '/';
